...
(function($){ 	
	...
	*/
	...
	var onGripDragOver = function(e){	
		...
		/*
		* fixed the element do not right delete:"<style type="text/css">*{cursor:e-resize!important}</style>"
		*  use:$("head").children().last().remove(); instead of $("head :last-child").remove();
		*/
